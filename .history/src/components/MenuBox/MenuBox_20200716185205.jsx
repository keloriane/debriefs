...
const menuTl = gsap.timeline();
  ...
  return (
    <nav className="menu-box">
      ...
      <div className="menu__item menu__item5">
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Non nemo soluta, rem tempore, asperiores id dolores maiores a ut accusantium quia ex? Doloremque illo ipsam at earum illum vel incidunt?</p>
      </div>
    </nav>
  );
};
