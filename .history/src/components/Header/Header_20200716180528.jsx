  ...
  const [menuOpen , setMenuOpen] = useState(false);
    ...
    const handleMenu = (e) => {
      ...
      if(menuOpen === false) {
        ...
        gsap.to(".menu__item1",{ duration:.5, opacity:0, y:"0%"})
        gsap.to(".menu__item2",{ duration:.5, opacity:0, x:"0%"})
        gsap.to(".menu__item3",{ duration:.5, opacity:0, x:"0%"})
        gsap.to(".menu__item4",{ duration:.5, opacity:0, x:"0%"})
        gsap.to(".menu__item5",{ duration:.5, opacity:0, y:"0%"})
