        ...
        <div id="home" ref={e=>home = e }>
            ...
            <div className="home-content">
                ...
                <div className="home-text">
                    <p ref={e=>line3 = e}>Notre spécificité un parfait mixte entre Marketing digital et Sécurité en ligne !</p>
                </div>
            </div>
            ...
            <button>
                ...
                <Link className="animated-button thar-three" to="/contact">Parlons digital</Link>
            </button>
                </div>
            </div>
            </div>
