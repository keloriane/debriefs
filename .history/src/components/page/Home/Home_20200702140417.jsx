...
export default function Home() {
    ...
    useEffect(()=> {
        ...
        const textArray = []
        textArray.push(subtitle);
        console.log(textArray,crumps,para);

        homeIntro
            .from(page,1,{x:"-100%"})
            .from(image,.5,{x:"-100%"} )
            .to(subtitle,.3,{y:-20,delay:1, opacity:1})
            .to(crumps,.3,{y:-20, delay:.2,opacity:1})
            .to(para,.3,{y:-20, delay:.2,opacity:1})
            .staggerFrom(path,.2,{x:100},.1);
            TweenMax.to(image,5,{scaleX:1.2, scaleY:1.2, delay:1})
    ...
    return (
        <div id="home">
            ...
            <div className="text-container">
                ...
                <p className="para">Notre spécificité un parfait mixte entre Marketing digital et Sécurité en ligne !</p>
            </div>
