            ...
            <div className="home-wrapper">
                ...
                <div className="center-home-content" ref={e => rightGap = e} >
                    <nav className="home-nav">
                        <ul>
                            <li><Link onClick={e => changePage(e , "/debriefs/contact")} to="/debriefs/services">SERVICES</Link></li>
                            <li><Link onClick={e => changePage(e , "/debriefs/webinaire")}>WEBINAIRES</Link></li>
