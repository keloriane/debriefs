  ...
  const handleNext = () => {
    ...
    switch (url) {
      case `/debriefs/services/${services[0].name}`:
        history.push(`/debriefs/services/${services[1].name}`);
        break;
      case `/debriefs/services/${services[1].name}`:
        history.push(`/debriefs/services/${services[2].name}`);
        break;
      case `/debriefs/services/${services[2].name}`:
        history.push(`/debriefs/services/${services[3].name}`);
        break;
      case `/debriefs/services/${services[3].name}`:
        history.push(`/debriefs/services/${services[4].name}`);
        break;
      case `/debriefs/services/${services[4].name}`:
        history.push(`/debriefs/services/${services[5].name}`);
        break;
      case `/debriefs/services/${services[5].name}`:
        history.push(`/debriefs/services/${services[0].name}`);
        break;
      default:
        break;
    }
