...
//     if (currentSlide === 0 && nextSlide === services.length - 1) {
//       this.setState({ index: services.length - 1 });
//     } else if (
//       nextSlide > currentSlide ||
//       (currentSlide === services.length - 1 && nextSlide === 0)
//     ) {
...
//                 0{this.state.index + 1}/0{services.length}
//               </div>
