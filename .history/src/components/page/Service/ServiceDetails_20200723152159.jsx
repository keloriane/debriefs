...
const ServiceDetails = () => {
  ...
  useEffect(()=>{
    ...
    const imageSlider = document.getElementsByClassName('slider-image')
        ...
        workTimeline
            .from(layer,.4,{x:"-50%", ease:"Power4.easeOut", delay:.5})
            .from(imageSlider,.5 ,{ease:"Power4.easeOut",x:"-100%", delay:-.2})
    ...
    <div className="work--container">
        ...
        <div className="inner--text--container">
            ...
            <div className="work--navigation">
                <div className="next">
                    <button className="button-nav button--next" onClick={handlePrevious}><p>Prev</p></button>
                </div>

                <div className="previous">
                    <button className="button-nav button--previous" onClick={handleNext}> <p>Next</p>  </button>
                </div>
            </div>
