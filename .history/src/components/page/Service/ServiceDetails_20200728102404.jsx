  ...
  const handleNext = () => {
    ...
    switch (url) {
      case `/debriefs/services/${services[0].name}`:
        history.push(`/debriefs/services/Dévelopement`);
        break;
      case `/debriefs/services/${services[1].name}`:
        history.push(`/debriefs/services/Stratégie`);
        break;
      case `/debriefs/services/${services[2].name}`:
        history.push(`/debriefs/services/Design`);
        break;
      case `/debriefs/services/${services[3].name}`:
        history.push(`/debriefs/services/Audit`);
        break;
      case `/debriefs/services/${services[4].name}`:
        history.push(`/debriefs/services/Workshop`);
        break;
