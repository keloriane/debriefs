...
const Webinaires = (props) => {
    ...
    useEffect(()=> {
        ...
        axios.get('https://www.eventbriteapi.com/v3/me/?token=A46DMBWAJN2Z2IVQ3K')
        .then((res)=> {
            console.log(res);
        })
    ...
    return (
        <div id="webinaire">
            <Nav animation={e => changePage(e , "/debriefs/")} animation0={e => changePage(e , "/debriefs/services")} animation1={e => changePage(e , "/debriefs/webinaire/")} animation2={e => changePage(e , "/techspace/")} animation3={e => changePage(e , "/blog")}  />
