...
const Techspace = () => {
    ...
    useEffect(() => {
        ...
        .from("#techspace",1,{background:"radial-gradient(80.27% 180.6% at 9.33% 71.2%, #041d2c 0%, #020f18 100%);"})
        .from(chars,.5,{y:100,ease:"sin.out( 1.7)", stagger:.04})
        .from([".screen-video", ".title-back-layer"], .4, { delay:-.3,width: -10, stagger: .3 })
