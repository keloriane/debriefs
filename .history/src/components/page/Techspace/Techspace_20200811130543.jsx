 ...
 const changePage=(e, destination) => {
    ...
    return (
        <div id="techspace">
            ...
            <nav>
                <Link to="/techspace/histoire">Notre Histoire</Link>
                <Link onClick={e => changePage(e , "/techspace/digital-career")} to="/techspace/digital-career">digital career center</Link>
                <Link onClick={e => changePage(e , "/debriefs/")} to="/debriefs">l'Agence</Link>
            </nav>
            </div>
