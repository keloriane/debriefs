                      ...
                      <div className="vertical-menu-line"></div>
                        <nav>
                            <ul className="mainmenu">
                                <li className="menu__item" > <Link className="menu__links" to="/debriefs/"> Accueil </Link> </li>
                                <li className="menu__item" > <Link className="menu__links" to="/debriefs/a-propos"> à propos </Link> </li>
                                <li className="menu__item" > <Link className="menu__links" to="/debriefs/services"> Services </Link> </li>
                                <li className="menu__item" > <Link className="menu__links" to="/debriefs/webinaire"> Webinaires </Link> </li>
                                <li className="menu__item" > <Link className="menu__links" to="/techspace/digital-career"> Digital career center </Link> </li>
                                <li className="menu__item" > <Link className="menu__links" to="/debriefs/contact"> Contact </Link> </li>
                            </ul>
                        </nav>
                    </div>
