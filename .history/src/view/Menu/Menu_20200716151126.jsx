...
const  Menu = (props,state) => {
  ...
  const changePage=(e, destination,proprit) => {
    e.preventDefault();
    menuTl.reverse();
    const timelineDuration = menuTl.duration()*1000;
    setTimeout(() => {
      console.log(proprit)
        proprit.history.push(destination);
      }, timelineDuration);
  }
            ...
            <div ref={el=>revealMenu = el} className="menu-layer">
                <div className="menu-container">
                    ...
                    <div className="menu-links">
                        <nav>
                            <ul>
                                <li> <Link onClick={e => changePage(e , "/debriefs/",props)} ref={el=>line1 = el} to="/debriefs/"> Accueil </Link> </li>
                                <li> <Link onClick={e => changePage(e , "/debriefs/a-propos")} ref={el=>line2 = el} to="/debriefs/a-propos"> à propos </Link> </li>
                                <li> <Link onClick={e => changePage(e , "/debriefs/services")}ref={el=>line3 = el} to="/debriefs/services"> Services </Link> </li>
                                <li> <Link onClick={e => changePage(e , "/debriefs/contact")}ref={el=>line4 = el} to="/debriefs/contact"> Contact </Link> </li>
                                <li> <Link onClick={e => changePage(e , "/debriefs/webinaire")} to="/debriefs/webinaire"> Webinaires </Link> </li>
                            </ul>
                        </nav>
                    </div>
