...
const  Menu = ({ state }) => {
  const changePage=(e, destination,props) => {
    e.preventDefault();
    menuTl.reverse();
    const timelineDuration = menuTl.duration()*1000;
    setTimeout(() => {
      console.log(state)
        window.history.push(destination);
      }, timelineDuration);
  }
            ...
            <div ref={el=>revealMenu = el} className="menu-layer">
                <div className="menu-container">
                    ...
                    <div className="menu-links">
                        <nav>
                            <ul>
                                <li> <Link onClick={e => changePage(e , "/debriefs/")} ref={el=>line1 = el} to="/debriefs/"> Accueil </Link> </li>
