            ...
            <div ref={el=>revealMenu = el} className="menu-layer">
                <div className="menu-container">
                    ...
                    <div className="menu-links">
                        <nav>
                            <ul>
                                <li> <Link ref={el=>line1 = el} to="/debriefs/a-propos"> à propos </Link> </li>
                                <li> <Link ref={el=>line2 = el} to="/debriefs/services"> Services </Link> </li>
                                <li> <Link ref={el=>line3 = el} to="/debriefs/"> Acceuil </Link> </li>
                                <li> <Link ref={el=>line5 = el} to="/debriefs/contact"> Contact </Link> </li>
                            </ul>
                        </nav>
                    </div>
                </div>
