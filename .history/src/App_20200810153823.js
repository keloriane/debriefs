  ...
  return (
    <HashRouter basename="/" >
       ...
       { loaded ? 
        ...
        <Cursor />
        <Header />
        <Nav animation={e => changePage(e , "/debriefs/")} animation0={e => changePage(e , "/debriefs/services")} animation2={e => changePage(e , "/webinaire/")} animation3={e => changePage(e , "/debriefs/blog/")} />
