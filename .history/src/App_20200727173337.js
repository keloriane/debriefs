import React, { useEffect, useState, createHistory } from 'react';
import './App.scss';
...
const routes = [
  ...
  { path: "/debriefs/services/:serviceId", name: "Detaille Services", Component: ServiceDetails, history={history} },
